...
class BookingAPIController extends Controller
{
    ...
    public function show($id, Request $request)
    {
        ...
        $booking = $this->bookingRepository->with('bookingStatus')->findWithoutFail($id);
        if (empty($booking)) {
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            // return $this->sendResponse($eProvider->taxes,'');
            ...
            Notification::send($eProvider, new NewBooking($booking));
