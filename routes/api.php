...
Route::prefix('provider')->group(function () {
    ...
    Route::get('users', 'API\EProvider\UserAPIController@users');
...
Route::get('e_providers{id}', 'API\EProviderAPIController@single_show');
...
Route::get('e_services{id}', 'API\EServiceAPIController@single_show');
