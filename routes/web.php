...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('/eProviders/{id}', 'EProviderController@single_show');
    ...
    Route::get('eServices/provider_create', 'ServiceProvideController@Create')->name('eServices.provider_create');
    Route::post('eServices/provider_create', 'ServiceProvideController@store')->name('eServices.provider_store');
    Route::get('eServices/my_services_table', 'ServiceProvideController@show')->name('eServices.my_services_table');
