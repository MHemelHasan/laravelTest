...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- E Provider Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        {!! Form::label('user_id', trans("lang.e_service_e_provider_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('user_id', $eProvider, null, ['class' => 'select2 form-control']) !!}
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <div class="d-flex flex-row justify-content-between align-items-center">
        ...
        <span class="icheck-{{setting('theme_color')}}">
            {!! Form::checkbox('available', 1, true) !!} <label for="available"></label> </span>
    </div>
